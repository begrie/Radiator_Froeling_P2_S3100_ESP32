...
#include <WiFi.h>
// #include <NetworkEvents.h> // nötig bei migration von framework arduino 2 auf 3 -> sollte eigentlich auch ohne gehen ... aber dann gibt es Probleme mit der WiFiEvent_t Definition
